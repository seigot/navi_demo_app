...
ApplicationWindow {
    ...
    property var texts: {
        ...
        "en_fishaudio": {
            "windowTitle": "Qt Navigation App (FishAudio)",
            "nextInstruction": "Next instruction:",
            "calculateRoute": "Calculate Route",
            "startDemo": "Start Demo",
            "stopDemo": "Stop Demo",
        ...
        "ja_fishaudio": {
            "windowTitle": "Qt ナビゲーションアプリ (FishAudio)",
            "nextInstruction": "次の指示:",
            "calculateRoute": "ルート計算",
            "startDemo": "デモ開始",
            "stopDemo": "デモ停止",
    ...
    function changeLanguage(lang) {
        if (lang === "ja" || lang === "en" || lang === "en_fishaudio" || lang === "ja_fishaudio") {
        ...
        Rectangle {
            ...
            RowLayout {
                ...
                ComboBox {
                    ...
                    model: ["English", "日本語", "English (FishAudio)", "日本語 (FishAudio)"]
                    Layout.fillWidth: true
                    currentIndex: 0
                    onCurrentIndexChanged: {
                        ...
                        if (currentIndex === 0) {
                            ...
                            langCode = "en_fishaudio";
                        } else if (currentIndex === 3) {
                            langCode = "ja_fishaudio";
                        }
                        
                        // Set language in backend
                        navController.setLanguage(langCode);
                        
                        // Update UI language
                        if (langCode === "en" || langCode === "en_fishaudio") {
                            currentLanguage = "en";
                            window.title = texts.en.windowTitle;
                        } else if (langCode === "ja" || langCode === "ja_fishaudio") {
                            currentLanguage = "ja";
                            window.title = texts.ja.windowTitle;
                        }
                    }
                }
